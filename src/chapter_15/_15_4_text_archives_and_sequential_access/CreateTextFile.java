...
public class CreateTextFile {
	...
	public static void openFile() {
		try {
			...
			if(!Files.exists(path)) // Verifica se o directorio files que esta na referencia da instancia de Path não existe
				Files.createDirectories(path);// Se não existir vamos criar o directorio.
	...
	public static void addRecords() {
		...
		while (scanner.hasNext()) { // hasNext() verifica se não foi inserida uma conbinação de teclas que indica o
									// fim da inserção, se for arquivo verifica se ja chegamos no fim do arquivo.
			try {
